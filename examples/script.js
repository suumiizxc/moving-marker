        ...
        timeout();
            function timeout() {
                setTimeout(function () {
                    ...
                    targetArray.push([48.8567 + 0.2 * mydata[loopVal].x, 2.35 + 2 * mydata[loopVal].y]);
...
//========================================================================
var marker1 = L.Marker.movingMarker(targetArray, [10000]).addTo(map);
L.polyline(targetArray).addTo(map);
